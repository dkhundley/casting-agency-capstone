...
class CastingTestCase(unittest.TestCase):
    ...
    # Creating a test to ensure a proper error is thrown if incorrect /movies
    # endpoint is called
    ...
    # Creating a test to ensure a proper error is thrown if incorrect /actors
    # endpoint is called
    ...
    # Creating a test to throw proper error if /movies/create endpoint not
    # called correctly
    ...
    # Creating a test to throw proper error if /actors/create endpoint not
    # called correctly
    ...
    # Creating a test to verify correct error is thrown when invalid movie_id
    # is passed to delete endpoint
    ...
    # Creating a test to verify correct error is thrown when invalid actor_id
    # is passed to delete endpoint
    ...
    # Creating a test to throw proper error when invalid movie_id is passed to
    # PATCH endpoint
    ...
    # Creating a test to throw proper error when invalid actor_id is passed to
    # PATCH endpoint
